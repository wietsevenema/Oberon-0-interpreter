...
// on Thursday, January 27, 2011 at 11:04:28 AM.
...
public final class Oberon extends ParserBase {
  ...
  private Result pEqualityExpression$1(final int yyStart) throws IOException {
    ...
    yyResult = pAdditiveExpresssion(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  private Result pEqualityExpression$$Tail1(final int yyStart) 
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pAdditiveExpresssion(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal eu.wietsevenema.lang.oberon.Oberon.AdditiveExpresssion.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAdditiveExpresssion(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.fAdditiveExpresssion) 
      yyColumn.fAdditiveExpresssion = pAdditiveExpresssion$1(yyStart);
    return yyColumn.fAdditiveExpresssion;
  }

  /** Actually parse eu.wietsevenema.lang.oberon.Oberon.AdditiveExpresssion. */
  private Result pAdditiveExpresssion$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pAdditiveExpresssion$$Tail1(yyRepetition1);
        yyError  = yyResult.select(yyError, yyRepetition1);
        if (yyResult.hasValue()) {
          final Action<Node> v$4 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal 
   * eu.wietsevenema.lang.oberon.Oberon.AdditiveExpresssion$$Tail1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAdditiveExpresssion$$Tail1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = new Action<Node>() {
          public Node run(Node v$1) {
            return GNode.create("AdditiveExpresssion", v$1, v$g$2, v$g$3);
          }};
