...
// on Wednesday, February 2, 2011 at 7:04:02 PM.
...
public final class Oberon extends ParserBase {
        ...
        if (yyResult.hasValue("DO")) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue("END")) {
              ...
              yyValue = new WhileStatement( exp, stats );
  ...
  /**
   * Parse nonterminal 
   * eu.wietsevenema.lang.oberon.parser.Declaration.IdentList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse eu.wietsevenema.lang.oberon.parser.Declaration.IdentList. */
