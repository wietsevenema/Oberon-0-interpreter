 ...
 * <code>eu.wietsevenema.lang.oberon.parser.Oberon</code>.
 * 
 * <p />
 * This class has been generated by the <i>Rats!</i> parser generator, version
 * 1.14.4, (C) 2004-2009 Robert Grimm.
 */
public final class Oberon extends ParserBase {
	 ...
	 *             Signals an I/O error.
	 */
	private Result peu$wietsevenema$lang$oberon$parser$Symbol$Symbol(
			final int yyStart) throws IOException {

		OberonColumn yyColumn = (OberonColumn) column(yyStart);
		if (null == yyColumn.chunk1)
			yyColumn.chunk1 = new Chunk1();
	...
	private Result peu$wietsevenema$lang$oberon$parser$Symbol$Symbol$1(
			final int yyStart) throws IOException {
		...
		yyResult = peu$wietsevenema$lang$oberon$parser$Symbol$SymbolCharacters(yyStart);
		yyError = yyResult.select(yyError);
		if (yyResult.hasValue()) {
			yyValue = yyResult.semanticValue();
	 ...
	 *             Signals an I/O error.
	 */
	private Result peu$wietsevenema$lang$oberon$parser$Symbol$SymbolCharacters(
			final int yyStart) throws IOException {
					...
					case '>': {
						...
						if (-1 != yyC) {
							...
							if ('=' == yyC) {
								...
								return new SemanticValue(yyValue, yyIndex,
										yyError);
							}
						}
			...
			if (yyResult.hasValue()) {
				...
				yyValue = new Action<Node>() {
					public Node run(Node v$1) {
						return GNode.create("EqualityExpression", v$1, v$g$2,
								v$g$3);
					}
				};
	...
	private Result pAdditiveExpression$$Tail1(final int yyStart)
		...
		if (yyResult.hasValue()) {
			...
			if (yyResult.hasValue()) {
				...
				yyValue = new Action<Node>() {
					public Node run(Node v$1) {
						return GNode.create("AdditiveExpression", v$1, v$g$2,
								v$g$3);
					}
				};
	...
	/**
	 * Parse synthetic nonterminal eu.wietsevenema.lang.oberon.parser.Oberon.
	 * MultiplicativeExpression$$Tail1.
	 * 
	 * @param yyStart
	 *            The index.
	 * @return The result.
	...
	private Result pMultiplicativeExpression$$Tail1(final int yyStart)
		...
		if (yyResult.hasValue()) {
			...
			if (yyResult.hasValue()) {
				...
				yyValue = new Action<Node>() {
					public Node run(Node v$1) {
						return GNode.create("MultiplicativeExpression", v$1,
								v$g$2, v$g$3);
					}
				};
	...
	/**
	 * Parse nonterminal eu.wietsevenema.lang.oberon.parser.Expression.
	...
	/**
	 * Actually parse eu.wietsevenema.lang.oberon.parser.Expression.
	 * LogicalConjunctiveExpression.
	 */
	...
	/**
	 * Parse synthetic nonterminal eu.wietsevenema.lang.oberon.parser.Oberon.
	 * LogicalConjunctiveExpression$$Tail1.
	 * 
	 * @param yyStart
	 *            The index.
	 * @return The result.
	...
	private Result pLogicalConjunctiveExpression$$Tail1(final int yyStart)
		...
		if (yyResult.hasValue("&")) {
			...
			if (yyResult.hasValue()) {
				...
				yyValue = new Action<Node>() {
					public Node run(Node v$1) {
						return GNode.create("LogicalConjunctiveExpression",
								v$1, v$g$2, v$g$3);
					}
				};
		...
		// Done.
		yyError = yyError.select("logical conjunctive expression expected",
				yyStart);
		return yyError;
	}
	...
	/**
	 * Parse synthetic nonterminal eu.wietsevenema.lang.oberon.parser.Oberon.
	 * LogicalDisjunctiveExpression$$Tail1.
	 * 
	 * @param yyStart
	 *            The index.
	 * @return The result.
	...
	private Result pLogicalDisjunctiveExpression$$Tail1(final int yyStart)
		...
		if (yyResult.hasValue("OR")) {
			...
			if (yyResult.hasValue()) {
				...
				yyValue = new Action<Node>() {
					public Node run(Node v$1) {
						return GNode.create("LogicalDisjunctiveExpression",
								v$1, v$g$2, v$g$3);
					}
				};
		...
		// Done.
		yyError = yyError.select("logical disjunctive expression expected",
				yyStart);
		return yyError;
	}
	...
	private Result pLogicalNegationExpression(final int yyStart)
		...
		// Done.
		yyError = yyError.select("logical negation expression expected",
				yyStart);
		return yyError;
	}
	...
	private Result pUnaryExpression(final int yyStart) throws IOException {
		OberonColumn yyColumn = (OberonColumn) column(yyStart);
		if (null == yyColumn.chunk2)
			yyColumn.chunk2 = new Chunk2();
		...
		if (yyResult.hasValue("ELSIF")) {
			...
			if (yyResult.hasValue()) {
				...
				if (yyResult.hasValue("THEN")) {
					...
					yyError = yyResult.select(yyError);
					if (yyResult.hasValue()) {
						final List<Statement> truestats = yyResult
								.semanticValue();
				...
				if (yyResult.hasValue("THEN")) {
					...
					if (yyResult.hasValue()) {
						...
						while (true) {
							...
							yyError = yyResult.select(yyError, yyRepetition1);
							if (yyResult.hasValue()) {
								final ElseIfStatement v$el$1 = yyResult
										.semanticValue();

								yyRepetition1 = yyResult.index;
								yyRepValue1 = new Pair<ElseIfStatement>(v$el$1,
										yyRepValue1);
								continue;
							}
							break;
						...
						{ // Start scope for elseifs.
							final Pair<ElseIfStatement> elseifs = yyRepValue1
									.reverse();
							...
							if (yyResult.hasValue("ELSE")) {
								...
								if (yyResult.hasValue()) {
									final List<Statement> v$el$2 = yyResult
											.semanticValue();
								...
								yyError = yyError.select("'ELSE' expected",
										yyBase);
							}
							{ // Start scope for falsestats.
								...
								if (yyResult.hasValue("END")) {
									...
									yyValue = new IfStatement(cond, truestats,
											elseifs.list(), falsestats);

									if (yyValue instanceof Locatable) {
										setLocation((Locatable) yyValue,
												yyStart);
									}
									return yyResult.createValue(yyValue,
											yyError);
								} else {
									yyError = yyError.select("'END' expected",
											yyBase);
								}
		...
		{ // Start scope for cd.
			...
			{ // Start scope for td.
				...
				{ // Start scope for vd.
					...
					yyError = yyResult.select(yyError);
					if (yyResult.hasValue()) {
						final Pair<ProcedureDecl> pds = yyResult
								.semanticValue();
	 ...
	 * eu.wietsevenema.lang.oberon.parser.Oberon.Declarations$$Star1.
	 */
	private Result pDeclarations$$Star1$1(final int yyStart) throws IOException {
			...
			if (yyResult.hasValue()) {
				...
				if (yyResult.hasValue(":")) {
					...
					if (yyResult.hasValue()) {
						...
						yyValue = GNode
								.create("FPSection", v$g$1, v$g$2, v$g$3);
					...
					if (yyResult.hasValue(";")) {
						...
						if (yyResult.hasValue()) {
							...
							if (yyResult.hasValue("BEGIN")) {
								...
								yyError = yyResult.select(yyError, yyOption1);
								if (yyResult.hasValue()) {
									final List<Statement> v$el$3 = yyResult
											.semanticValue();
								...
								yyError = yyError.select("'BEGIN' expected",
										yyBase);
							}
							{ // Start scope for stats.
								...
								if (yyResult.hasValue("END")) {
									...
									yyError = yyResult.select(yyError);
									if (yyResult.hasValue()) {
										final Node idend = yyResult
												.semanticValue();

										yyValue = new ProcedureDecl(idstart,
												formals, decls, stats);
				...
				if (yyResult.hasValue(";")) {
					...
					if (yyResult.hasValue()) {
						...
						if (yyResult.hasValue("BEGIN")) {
							...
							yyError = yyResult.select(yyError, yyOption1);
							if (yyResult.hasValue()) {
								final List<Statement> v$el$1 = yyResult
										.semanticValue();
							...
							if (yyResult.hasValue("END")) {
								...
								if (yyResult.hasValue()) {
									...
									if (yyResult.hasValue(".")) {
										...
										yyValue = new Module(idstart, decls,
												stats);
						...
						case '*': {
							...
							if ('*' == yyC) {
								...
								if ('/' == yyC) {
									...
									yyError = yyError.select("'*/' expected",
											yyBase);
								}
							} else {
								yyError = yyError.select("'*/' expected",
