...
// on Sunday, January 30, 2011 at 9:36:37 PM.
...
public final class Oberon extends ParserBase {
  ...
  /** Actually parse eu.wietsevenema.lang.oberon.parser.Oberon.Declarations. */
  ...
  /** Actually parse eu.wietsevenema.lang.oberon.parser.Oberon.IdentList. */
  ...
  /**
   * Parse nonterminal eu.wietsevenema.lang.oberon.parser.Oberon.FPSection.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pFPSection(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fFPSection) 
      yyColumn.chunk1.fFPSection = pFPSection$1(yyStart);
    return yyColumn.chunk1.fFPSection;
  }

  /** Actually parse eu.wietsevenema.lang.oberon.parser.Oberon.FPSection. */
    ...
    { // Start scope for v$g$1.
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue(":")) {
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            final Type v$g$3 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal 
   * eu.wietsevenema.lang.oberon.parser.Oberon.FormalParameters.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal 
   * eu.wietsevenema.lang.oberon.parser.Oberon.ProcedureDecl.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse eu.wietsevenema.lang.oberon.parser.Oberon.StatementSequence. */
  ...
  /**
   * Parse nonterminal 
   * eu.wietsevenema.lang.oberon.parser.Oberon.ProcedureCallStatement.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal 
   * eu.wietsevenema.lang.oberon.parser.Oberon.ActualParameters.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pAdditiveExpression(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAdditiveExpression) 
      yyColumn.chunk2.fAdditiveExpression = pAdditiveExpression$1(yyStart);
    return yyColumn.chunk2.fAdditiveExpression;
  }
  ...
  private Result pMultiplicativeExpression(final int yyStart) 
    ...
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fMultiplicativeExpression) 
      yyColumn.chunk2.fMultiplicativeExpression = pMultiplicativeExpression$1(yyStart);
    return yyColumn.chunk2.fMultiplicativeExpression;
  }
